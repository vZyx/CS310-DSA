...
public class StaticArray
{
    ...
    {
        StaticArray arr1 = new StaticArray();
        int[] arr = new int[5];
        ...
        arr1.insertMiddle(arr, 0, 1, 0);
        arr1.insertMiddle(arr, 2, 3, 1);
        arr1.insertMiddle(arr, 4, 5, 2);
        // Print the array after insertions
        System.out.println("Array after insertions:");
        arr1.printArr(arr, 5);

        // Remove elements from different positions
        arr1.removeMiddle(arr, 1, 3);
        arr1.removeMiddle(arr, 3, 2);

        // Print the array after removals
        System.out.println("Array after removals:");
        arr1.printArr(arr, 5);
    }
